		...
		<div class="w-full px-10 xl:inline-flex xl:w-1/2 xl:flex-col">
			<div class="max-w-xl py-10 m-auto">
				...
				<p class="text-xl text-gray-700 mt-5">
					est auteur, compositeur et interprète de ses chansons. Épris de science et de littérature,
					il évolue dans le monde de la recherche en écologie marine pendant cinq années avant de
					s'en éloigner pour prendre le temps de voyager.
				</p>
